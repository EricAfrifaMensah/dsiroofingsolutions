        ...
        <div className="bg-roofing-blue text-white p-8 md:p-12 flex items-center">
          <div className="max-w-lg">
            ...
            <p className="text-lg leading-relaxed mb-8 opacity-90">
              DSI Roofing Solution: We sell and install high quality classic roofing sheets at a lowest prices in the market now giving to the reliable distributors, engineers, marketers, retailers, installers and others.
            </p>
